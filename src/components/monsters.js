const monsters = [
    {
        name: "Frankenstein",
        type: "undead",
        weakness: "Frankenstein is afraid of fire, and will lash out erratically if faced with even the smallest flame.",
        bounty: "$300",
    ...
    },
    {
        name: "Pumpkin-Head",
        type: "demon",
        weakness: "Hammers are Pumpkin-Head's biggest fear, since the only way to kill a Pumpkin-Head is to crush it's pumpkin-head.",
        bounty: "$1031",
    ...
    },
    {
        name: "Ursula",
        type: "sea witch",
        weakness: "A sea witch's greatest fear is the air--to be trapped away from the ocean, and forced to walk on human legs.",
        bounty: "$777",
    ...
    {
        name: "Golem of Gartholomew",
        type: "golem/creation",
        weakness: "Golems are afraid of the item that breaks down the material they are created from. Gartholomew is a mud golem, so can easily be destroyed with a high-pressure water stream.",
        bounty: "$1389",
    ...
    },
    {
        name: "Beetlejuice",
        type: "cursed spirit",
        weakness: "Beetlejuice is a mouthy trickster, and isn't afraid of anything--except, hellworms.",
        bounty: "$1988",
    ...
    },
    {
        name: "Vechorko",
        type: "harvest devil",
        weakness: "Harvest devils often fear natural disasters (such as extreme wind, wildfires, or floods) since they believe these events are brought on by angry gods.",
        bounty: "$300",
    ...
    },
    {
        name: "Voidboi",
        type: "cat demon",
        weakness: "Cat demons have only one fear--and even that fear is tiny: fleas.",
        bounty: "$6666",
    ...
    },
    {
        name: "Blood Kraken",
        type: "kraken",
        weakness: "The Blood Kraken has been terrorizing the seas of Eastern Scotland for decades now. While it has grown to incredible size and strength, its greatest weakness is that it's slow.",
        bounty: "$1688",
